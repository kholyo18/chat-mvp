...
const seedProducts: SeedProduct[] = [
  ...
  },
  {
    ...
    data: {
      title: "Silver VIP",
      subtitle: "Unlock Silver VIP perks",
      price_cents: 999,
      currency: "USD",
      stripe_price_id: "price_vip_silver",
      icon: "vip",
      badge: "VIP",
      active: true,
      type: "vip",
  ...
  },
  {
    ...
    data: {
      title: "Gold VIP",
      subtitle: "Unlock Gold VIP perks",
      price_cents: 1499,
      currency: "USD",
      stripe_price_id: "price_vip_gold",
      icon: "vip",
      badge: "VIP",
      active: true,
      type: "vip",
  ...
  },
  {
    ...
    data: {
      title: "Platinum VIP",
      subtitle: "Unlock Platinum VIP perks",
      price_cents: 2499,
      currency: "USD",
      stripe_price_id: "price_vip_platinum",
      icon: "vip",
      badge: "VIP",
      active: true,
      type: "vip",
